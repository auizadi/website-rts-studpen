...
<body class="dark:bg-gray-900 bg-gray-200">
    ...
    <aside class="w-64 bg-white border-r overflow-y-auto p-5 rounded-lg my-20 ml-12">
        <nav class="space-y-4">

                <a href="#" class="flex items-center font-medium p hover:">
                    <i class="fa-solid fa-list-check p-2 rounded-full bg-blue-500 text-white"></i>
                    <span class="mx-10 p-2">Simulasi</span>
                </a>
